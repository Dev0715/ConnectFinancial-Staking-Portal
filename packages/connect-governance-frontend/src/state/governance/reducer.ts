...
const GovernorAlphaLocalDeployment: any = require('@connectfinancial/connect-token/deployments/local/GovernorAlpha');
const CNDLocalDeployment: any = require('@connectfinancial/connect-token/deployments/local/CND');
...
export const UNI_GOVERNANCE_ADDRESS = GovernorAlphaLocalDeployment.address;
export const UNI_ADDRESS = CNDLocalDeployment.address;
